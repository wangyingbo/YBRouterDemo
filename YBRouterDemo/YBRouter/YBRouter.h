...
//定义：类-默认类名即路由
#define YBControllerRegisterClass(cla) YBControllerRegister(cla,ROUTER_PREFIX,cla)
//定义：类-自定义路由
...
#define YBControllerRegisterClassRouter(cla,router) YBControllerCustomRegister(cla,ROUTER_PREFIX,router)
...
extern id yb_msgSend(id target, SEL selector,id firstParameter, ...);
